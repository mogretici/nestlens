...
/**
 * Toolbar state for a JSON viewer, and the controls that drive it.
 *
 * Kept out of the file that renders the viewer: a module exporting both a
 * component and a hook loses fast refresh, so editing either one remounted the
 * tree instead of patching it.
 */
