...
describe('ClickableBadge', () => {
  ...
  describe('Navigation with explicit filterTypes', () => {
    ...
    const correctlyHandledFilterTypes: Array<{
      ...
      { filterType: 'types', expectedParam: 'queryTypes', testValue: 'SELECT', listType: 'queries' },
      ...
      { filterType: 'operations', expectedParam: 'cacheOperations', testValue: 'get', listType: 'cache' },
